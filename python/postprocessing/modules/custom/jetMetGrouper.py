...
moreVars = [
    ...
    {'name' : 'MET_T1_pt_jer'            , 'rootBranchType' : 'F'},
...
moreVars2017 = [
    {'name' : 'Jet_pt_nom'                        , 'rootBranchType' : 'F','lenVar': 'nJet'},
    {'name' : 'METFixEE2017_T1_pt'                , 'rootBranchType' : 'F'},
    {'name' : 'METFixEE2017_T1_pt_jer'            , 'rootBranchType' : 'F'},
    {'name' : 'METFixEE2017_T1_pt_unclustEnUp'    , 'rootBranchType' : 'F'},
    {'name' : 'METFixEE2017_T1_pt_unclustEnDown'  , 'rootBranchType' : 'F'},
    {'name' : 'METFixEE2017_T1_phi_unclustEnUp'   , 'rootBranchType' : 'F'},
    {'name' : 'METFixEE2017_T1_phi_unclustEnDown' , 'rootBranchType' : 'F'},
]
...
moreVars.extend( [
    ...
    {'name' : 'MET_T1_pt_HEMUp'    , 'rootBranchType' : 'F'},
    {'name' : 'MET_T1_phi_HEMUp'   , 'rootBranchType' : 'F'},
    {'name' : 'Jet_pt_HEMDown'     , 'rootBranchType' : 'F','lenVar': 'nJet'},
    {'name' : 'MET_T1_pt_HEMDown'  , 'rootBranchType' : 'F'},
    {'name' : 'MET_T1_phi_HEMDown' , 'rootBranchType' : 'F'},
])
...
for jer in ['barrel','endcap1','endcap2highpt','endcap2lowpt' ,'forwardhighpt','forwardlowpt']:
    for var in ['Up','Down']:
        moreVars2017.extend( [
            {'name' : 'Jet_pt_jer%s%s'%(jer,var)              , 'rootBranchType' : 'F','lenVar': 'nJet'},
            {'name' : 'METFixEE2017_T1_pt_jer%s%s'%(jer,var)  , 'rootBranchType' : 'F'},
            {'name' : 'METFixEE2017_T1_phi_jer%s%s'%(jer,var) , 'rootBranchType' : 'F'},
        ])

moreVars2017.extend( [
    {'name' : 'Jet_pt_HEMUp'                , 'rootBranchType' : 'F','lenVar': 'nJet'},
    {'name' : 'METFixEE2017_T1_pt_HEMUp'    , 'rootBranchType' : 'F'},
    {'name' : 'METFixEE2017_T1_phi_HEMUp'   , 'rootBranchType' : 'F'},
    {'name' : 'Jet_pt_HEMDown'              , 'rootBranchType' : 'F','lenVar': 'nJet'},
    {'name' : 'METFixEE2017_T1_pt_HEMDown'  , 'rootBranchType' : 'F'},
    {'name' : 'METFixEE2017_T1_phi_HEMDown' , 'rootBranchType' : 'F'},
])
...
#jetMetCorrelate2016 = lambda  : jetmetGrouper( groups, "Jet", "MET_T1",          dumpMore = moreVars     )
#jetMetCorrelate2017 = lambda  : jetmetGrouper( groups, "Jet", "METFixEE2017_T1", dumpMore = moreVars2017 )
#jetMetCorrelate2018 = lambda  : jetmetGrouper( groups, "Jet", "MET_T1",          dumpMore = moreVars     )
jetMetCorrelate2016 = lambda  : jetmetGrouper( groups, "Jet", "MET_T1")
jetMetCorrelate2017 = lambda  : jetmetGrouper( groups, "Jet", "METFixEE2017_T1")
jetMetCorrelate2018 = lambda  : jetmetGrouper( groups, "Jet", "MET_T1")
